...
class ProcuctsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create procuct" do
    assert_difference('Procuct.count') do
      post procucts_url, params: { procuct: { name: @procuct.name, price: @procuct.price, vendor: @procuct.vendor } }
    end
  ...
  test "should update procuct" do
    patch procuct_url(@procuct), params: { procuct: { name: @procuct.name, price: @procuct.price, vendor: @procuct.vendor } }
